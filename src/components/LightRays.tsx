  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      const renderer = new Renderer({
        // Performance option: Caps rendering scale to 0.75 on mobile screens to save GPU power and battery
      ...
      const updatePlacement = () => {
        ...
        renderer.dpr = isMobile ? 0.75 : Math.min(window.devicePixelRatio, 2);
    ...
    initializeWebGL();
    return () => { if (cleanupFunctionRef.current) cleanupFunctionRef.current(); };
